...
class AppContainer(context: Context) {
    ...
    val webFeedSyncManager by lazy {
        com.detailline.callfollowcrm.ai.WebFeedSyncManager(
            webFeedRepository, preferences, customerRepository, jobRepository, categoryRepository,
            cachedMessageRepository, callSummaryRepository
        )
    }
    ...
    val ownerPhotoUploadManager by lazy {
        com.detailline.callfollowcrm.ai.OwnerPhotoUploadManager(
            context.applicationContext, db.sitePhotoDao(), customerRepository, jobRepository,
            sitePhotoServerRepository, preferences
        )
    }
    ...
    val backupRepository = com.detailline.callfollowcrm.ai.BackupRepository(ownerPhone = { preferences.bizPhone })
