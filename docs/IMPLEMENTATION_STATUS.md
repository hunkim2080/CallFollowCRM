...
| 영역 | 완료 | 핵심 빈칸 |
|---|---|---|
| 상담함(홈) | 6/9 | (히어로·다음시공·자동답장·정기문자대기 ✅) 접수서/팀사진 알림 남음 |
...
| 더보기 | 5/7 | (비즈니스 리포트·정기문자 ✅) 자동문자(부분)·팀 남음 |
| 온보딩 | 4/4 | ✅ 완료 (권한·업종·막내비서·스토리텔링) |
| 데이터·AI 기반 | 3/3 | (토대 완성) |

전체: **43 완료 / 52 항목 (약 83%)**. 나머지는 진행중/시작전. (2026-06-01 누적 20개 기능. 추가: 정기문자 예약(DB v25)+발송 대기 알림 — 시공 후 N일 안부/점검, 포그라운드 계산·확인 후 발송. 상담함 6/9·더보기 5/7)
