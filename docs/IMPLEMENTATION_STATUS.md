...
| 영역 | 완료 | 핵심 빈칸 |
|---|---|---|
| 상담함(홈) | 5/9 | (오늘시공 히어로·다음시공·자동답장 카드 ✅) 정기/접수 알림 남음 |
| 채팅 | 4/7 | 통화구간, 접수서 단계 |
| 일정 | 4/5 | (셀프등록·시간칩·여러날기간 ✅) 내 일정 확인(채팅) 남음 |
...
전체: **39 완료 / 52 항목 (약 75%)**. 나머지는 진행중/시작전. (2026-06-01 누적 17개 기능. 추가: 시공 시간 칩 + 여러 날 기간(DB v24) → 일정 영역 4/5)
...
- ⬜ 내 일정 확인(채팅에서) — 채팅 중 미니 달력으로 빈 날/시공일 확인 (다음)
...
## 데이터 · AI 기반
- ✅ Room DB v24 (18개 엔티티) / ✅ 맥미니 AI 서버 연동 / ✅ 추천 이벤트 로깅
