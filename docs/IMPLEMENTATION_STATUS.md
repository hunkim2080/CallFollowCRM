...
| 정산 | 7/8 | (미수금·현금흐름·순이익·월매출전월대비 ✅) 일당 자동차감만 남음(Phase 3) |
...
전체: **34 완료 / 52 항목 (약 65%)**. 나머지는 진행중/시작전. (2026-06-01 누적 14개 기능: 정산 P1+2, 홈 히어로/다음시공, 셀프 일정, 사업자정보, 수첩+문구, 비즈니스 리포트, 업종 선택, 평당계산, 막내비서, 스토리텔링, 정식견적서공유, 월매출전월대비)
...
- ⬜ 일당 자동 차감(일정↔정산, 일당배정 모델 신규 = Phase 3)
