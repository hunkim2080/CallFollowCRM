...
| 수첩 | 2/4 | (일당·거래처 CRUD ✅) 함께한현장·자주쓰는문구 남음 |
| 견적·접수서 | 2/5 | (사업자정보 ✅) 시공접수서·견적서PDF·평당계산 남음 |
| 더보기 | 3/7 | 정기문자, 비즈니스 리포트, 팀 |
| 온보딩 | 1/4 | 업종선택, 막내비서 |
| 데이터·AI 기반 | 3/3 | (토대 완성) |

전체: **26 완료 / 51 항목 (약 51%)**. 나머지는 진행중/시작전. (2026-06-01 정산 P1+2 + 홈 히어로/다음시공 + 셀프 일정 + 사업자정보 + 수첩)
