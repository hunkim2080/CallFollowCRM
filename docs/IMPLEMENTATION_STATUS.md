...
| 수첩 | 3/4 | (일당·거래처·자주쓰는문구 ✅) 함께한 현장만 남음 |
| 견적·접수서 | 3/5 | (사업자정보·평당계산 ✅) 시공접수서·견적서PDF 남음 |
| 더보기 | 4/7 | (비즈니스 리포트 ✅) 정기문자·팀 남음 |
| 온보딩 | 3/4 | (업종선택·막내비서 ✅) 스토리텔링 7장만 남음 |
| 데이터·AI 기반 | 3/3 | (토대 완성) |

전체: **31 완료 / 51 항목 (약 61%)**. 나머지는 진행중/시작전. (2026-06-01: 정산 P1+2, 홈 히어로/다음시공, 셀프 일정, 사업자정보, 수첩+문구, 비즈니스 리포트, 업종 선택, 평당계산, 막내비서)
...
- ✅ **막내 비서 캐릭터** — `Mascot`(Compose Canvas, 안전모) + 온보딩 히어로 "막내 비서 탄생!" 배지.
- ⬜ 스토리텔링 7장 (인터랙티브 캐러셀)
